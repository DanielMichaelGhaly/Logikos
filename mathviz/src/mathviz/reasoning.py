"""
Step text generation from trace (rule-based) with natural language explanations.
"""
...
class ReasoningGenerator:
    ...
    def __init__(self):
        """Initialize with operation templates and mathematical language patterns."""
    ...
    def generate_reasoning(self, trace: StepTrace) -> str:
        """Generate comprehensive reasoning text from a step trace."""
        if not trace.steps:
