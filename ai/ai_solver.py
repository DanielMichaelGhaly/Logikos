...
Handles communication with AI models via Ollama for mathematical problem solving.
"""
...
class AISolver:
    """Interface for AI models via Ollama"""
    
    def __init__(self, 
                 ollama_host: str = "http://localhost:11434",
                 model_name: str = "Randomblock1/nemotron-nano:latest"):
    ...
    def solve_problem(self, problem: str, problem_type: str = "general") -> AIResponse:
        ...
        try:
            logger.info(f"Requesting AI solution for: {problem}")
